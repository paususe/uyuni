...
public class PkgProfileUpdateSlsResult {
    ...
    public static final String PKG_PROFILE_ALINUX_RELEASE =
            "cmd_|-oraclerelease_|-cat /etc/alinux-release_|-run";
    ...
    @SerializedName(PKG_PROFILE_ALINUX_RELEASE)
    private StateApplyResult<CmdResult> alinuxReleaseFile;
     ...
     */
    public StateApplyResult<CmdResult> getAlinuxReleaseFile() {
        return alinuxReleaseFile;
    }
